...
// 	try {
// 		await (
// 			await content.fetch('https://academic.bits-pilani.ac.in/dashboard.aspx/addSession', {
// 				method: 'POST',
// 				headers: {
...
// 	} catch {
// 		await (
// 			await fetch('https://academic.bits-pilani.ac.in/dashboard.aspx/addSession', {
// 				method: 'POST',
// 				headers: {
// 					Accept: 'application/json, text/javascript, */*; q=0.01',
// 					'Content-Type': 'application/json; charset=utf-8',
...
// 	} catch {
// 		user = await (
// 			await fetch(`https://www.googleapis.com/oauth2/v1/userinfo?access_token=${acToken}`)
// 		).json();
// 	}

// 	//Check BITS Pilani
// 	let domain_matcher = /@(.*)$/.exec(user.email);
// 	let domain_name = domain_matcher[1].substring(0, domain_matcher[1].indexOf('.', 0));
...
// 		try {
// 			if (tab.document.URL.indexOf('https://academic.bits-pilani.ac.in') != -1) {
